...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 items-center justify-center rounded-xl bg-zinc-100 p-1 text-zinc-500 shadow-sm",
      className
    )}
    {...props}
  />
